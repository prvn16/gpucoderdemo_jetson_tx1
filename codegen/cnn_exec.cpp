...
void CnnMain::setup()
{
    ...
    this->layers[0]->loadAvg(".\\codegen\\cnn_CnnMain_avg_7");
    this->layers[1]->createConvLayer(this->layers[0], 11, 11, 3, 96, 4, 4, 0, 0, 1);
    this->layers[1]->loadWeights(".\\codegen\\cnn_CnnMain_conv1_w_7");
    this->layers[1]->loadBias(".\\codegen\\cnn_CnnMain_conv1_b_7");
    ...
    this->layers[5]->loadWeights(".\\codegen\\cnn_CnnMain_conv2_w_7");
    this->layers[5]->loadBias(".\\codegen\\cnn_CnnMain_conv2_b_7");
    ...
    this->layers[9]->loadWeights(".\\codegen\\cnn_CnnMain_conv3_w_7");
    this->layers[9]->loadBias(".\\codegen\\cnn_CnnMain_conv3_b_7");
    this->layers[10]->createReLULayer(this->layers[9]);
    this->layers[11]->createConvLayer(this->layers[10], 3, 3, 192, 192, 1, 1, 1, 1, 2);
    this->layers[11]->loadWeights(".\\codegen\\cnn_CnnMain_conv4_w_7");
    this->layers[11]->loadBias(".\\codegen\\cnn_CnnMain_conv4_b_7");
    this->layers[12]->createReLULayer(this->layers[11]);
    this->layers[13]->createConvLayer(this->layers[12], 3, 3, 192, 128, 1, 1, 1, 1, 2);
    this->layers[13]->loadWeights(".\\codegen\\cnn_CnnMain_conv5_w_7");
    this->layers[13]->loadBias(".\\codegen\\cnn_CnnMain_conv5_b_7");
    ...
    this->layers[16]->loadWeights(".\\codegen\\cnn_CnnMain_fc6_w_7");
    this->layers[16]->loadBias(".\\codegen\\cnn_CnnMain_fc6_b_7");
    ...
    this->layers[19]->loadWeights(".\\codegen\\cnn_CnnMain_fc7_w_7");
    this->layers[19]->loadBias(".\\codegen\\cnn_CnnMain_fc7_b_7");
    ...
    this->layers[22]->loadWeights(".\\codegen\\cnn_CnnMain_fc8_w_7");
    this->layers[22]->loadBias(".\\codegen\\cnn_CnnMain_fc8_b_7");

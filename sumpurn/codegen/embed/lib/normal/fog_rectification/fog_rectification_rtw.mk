###########################################################################
## Makefile generated for MATLAB file/project 'fog_rectification'. 
## 
## Makefile     : fog_rectification_rtw.mk
## Generated on : Thu Jan 25 08:55:21 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\fog_rectification.lib
...
PRODUCT_NAME              = fog_rectification
MAKEFILE                  = fog_rectification_rtw.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Sumpurn\Projects\GPU\gpucoderdemo_jetson_tx1
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\fog_rectification.lib
...
INCLUDES_BUILDINFO = $(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -D MODEL=fog_rectification -D HAVESTDIO -D USE_RTMODEL
...
SRCS = $(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification\fog_rectification_initialize.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification\fog_rectification_terminate.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification\fog_rectification.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification\rt_nonfinite.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification\rtGetNaN.cu $(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification\rtGetInf.cu
...
OBJS = fog_rectification_initialize.obj fog_rectification_terminate.obj fog_rectification.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
{$(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification}.cu.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"


{$(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification}.c.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"
...
{$(START_DIR)\sumpurn\codegen\embed\lib\normal\fog_rectification}.cpp.obj :
	$(CPP) $(CPPFLAGS) -o  "$@" "$<"

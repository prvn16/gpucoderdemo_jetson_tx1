 ...
 * File: _coder_fog_rectification_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "fog_rectification",                 /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static uint8_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray *input,
 ...
 * Return Type  : void
 */
void fog_rectification_api(const mxArray * const prhs[1], const mxArray *plhs[1])
{
  uint8_T (*out)[921600];
  ...
  input = emlrt_marshallIn(&st, emlrtAlias((const mxArray *)prhs[0]), "input");

  /* Invoke the target function */
  fog_rectification(*input, *out);
...
void fog_rectification_atexit(void)
{
  ...
  fog_rectification_xil_terminate();
}
...
/*
 * File trailer for _coder_fog_rectification_api.c
 *
 * [EOF]
 */
